...
public static final  String PLAYER_OVER_FIRST="player_over_first";
    ...
    private void initXRecyclerView() {
        ...
        playBackReviewAdapter.setOnReviewItemClickListener(new PlayBackReviewAdapter.OnReviewItemClickListener() {
            ...
            public void itemClick(int targetId,int userId,String userName) {
                // 回复评论
                if(!isOnStop){
                    if(userId== UserHelper.getUserId(PlayBackDetailActivity.this)){
    ...
    private void showReplyDialog(final int targetId, final int userId, final String userName) {
        DialogUtils.createListDialog(PlayBackDetailActivity.this,0,null,mDialogItems, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if(which==0){
                    //回复
                    Intent intent = new Intent(PlayBackDetailActivity.this, RePlyActivity.class);
                    ...
                    //举报
                    Toast.makeText(PlayBackDetailActivity.this,"举报功能暂未开启!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
  ...
  public void showHintDialog(final int targetId){
      final CustomChatDialog customChatDialog = new CustomChatDialog(PlayBackDetailActivity.this);
    ...
    public void clickBtn(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.enter_playback_layout:
                // TODO 视频回放
                Intent intent = new Intent(PlayBackDetailActivity.this, PlayBackActivity.class);
                intent.putExtra("id",intentId);
            if(!SPCUtils.getBoolean(PlayBackDetailActivity.this,PLAYER_OVER_FIRST)){
                SPCUtils.put(PlayBackDetailActivity.this,PLAYER_OVER_FIRST,true);
            ...
            case R.id.reply_write_iv:
                if(UserHelper.isLogined(PlayBackDetailActivity.this)){
                    toRePlyActivity();
                }else{
            ...
            case R.id.play_back_bottom_table_transmit_layout:
                if(shareVO!=null){
                    SharePopupWindow shareActivity = new SharePopupWindow(PlayBackDetailActivity.this,shareVO);
    ...
    public void showLoginViewDialog() {
        ...
        customDialog.setSurceBtn(getString(R.string.live_login_imm), new CustomChatDialog.CustomDialogListener() {
            @Override
            public void onDialogClickListener() {
                LLoginActivity.startForResult(PlayBackDetailActivity.this, 701);
            }
        });
        ...
        public void onDeleteComment(CommentOperateResp commentOperateResp) {
            ...
            if (commentOperateResp.getReturnCode() == 0) {
                ...
                if (TextUtils.equals(message, "success")) {
                    Toast.makeText(PlayBackDetailActivity.this, "评论删除成功", Toast.LENGTH_SHORT).show();
                    // 请求评论
                    isRefresh=true;
                    contentLoader.getPlayBackLiveReview(intentId, 20, 10, 1);
                    return;
            ...
            Toast.makeText(PlayBackDetailActivity.this, "评论删除失败，请稍后再试~", Toast.LENGTH_SHORT).show();
        }
            ...
            try{
                if (liveRowsBean != null) {
                    ...
                    if (photo != null) {
                        ...
                        DrawableUtils.loadingImg(PlayBackDetailActivity.this, videoCover, QiniuUtils.centerCrop(photo, DensityUtil.getWindowWidth(PlayBackDetailActivity.this), DensityUtil.dip2px(PlayBackDetailActivity.this, 258)));
                    }
                    detailsRefresh = true;
                    if (reviewRefresh) {
