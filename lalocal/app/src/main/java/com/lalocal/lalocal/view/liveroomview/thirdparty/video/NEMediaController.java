...
package com.lalocal.lalocal.view.liveroomview.thirdparty.video;
...
public class NEMediaController extends FrameLayout {
    ...
    public NEMediaController(Context context, ViewGroup videoLayout) {
        super(context);
    ...
    public void show(int timeout) {
        if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
            ...
            if (mFromXml) {
                ...
                // 控制条高度的一半 ScreenUtil.dip2px(25) 。参考mediacontroller.xml的根布局layout_height
                mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, 0, mAnchor.getHeight() - ScreenUtil.dip2px(25));
            }
            mShowing = true;
...
//        }
	...
	private OnClickListener mSetPlayerScaleListener = new OnClickListener() {
		...
		public void onClick(View v) {
            if (mIsFullScreen) {
                mVideoScalingMode = VIDEO_SCALING_MODE_FILL;
                mSetPlayerScaleButton.setImageResource(R.drawable.nemediacontroller_scale02);
                mIsFullScreen = false;
