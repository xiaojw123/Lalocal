...
//                mClearDrawable.getIntrinsicHeight());
        mClearDrawable.setBounds(0, 0,(int) getResources().getDimension(R.dimen.register_clear_btn_width),
                (int) getResources().getDimension(R.dimen.register_clear_btn_width));
        // 默认设置隐藏图标  
