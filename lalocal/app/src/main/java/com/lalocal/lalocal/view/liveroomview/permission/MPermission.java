package com.lalocal.lalocal.view.liveroomview.permission;
...
import com.lalocal.lalocal.view.liveroomview.permission.annotation.OnMPermissionNeverAskAgain;
import com.lalocal.lalocal.view.liveroomview.permission.util.MPermissionUtil;
...
public class MPermission {
    ...
    private static List<String> getDeniedPermissions(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findDeniedPermissions((Activity) activity, permissions);
    }
    ...
    private static List<String> getNeverAskAgainPermissions(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findNeverAskAgainPermissions((Activity) activity, permissions);
    }
    ...
    private static List<String> getDeniedPermissionsWithoutNeverAskAgain(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findDeniedPermissionWithoutNeverAskAgain((Activity) activity, permissions);
    }
    ...
    private static void requestPermissions(Object object, int requestCode, String[] permissions) {
        ...
        List<String> deniedPermissions = MPermissionUtil.findDeniedPermissions((Activity) object, permissions);
    ...
    private static void requestResult(Object obj, int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (deniedPermissions.size() > 0) {
            if (MPermissionUtil.hasNeverAskAgainPermission((Activity) obj, deniedPermissions)) {
