...
public class CategoryViewHolder extends RecyclerView.ViewHolder {
     ...
     * @param itemView
     */
    public CategoryViewHolder(final Context context, final View itemView, RecyclerView recyclerView) {
        super(itemView);
        ...
        mLayoutArticle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(mContext,"点击了旅行笔记"+lastPosition,Toast.LENGTH_SHORT).show();

                if(itemClick!=null){
                    itemClick.clickPosition(lastPosition);
                }
            }
        });
