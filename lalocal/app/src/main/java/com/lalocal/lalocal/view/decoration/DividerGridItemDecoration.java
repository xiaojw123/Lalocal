...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context) {
        ...
        paint = new Paint();
        paint.setColor(mContext.getResources().getColor(R.color.color_30191000));
        paint.setStrokeWidth(mContext.getResources().getDimension(R.dimen.dimen_size_2_dp));
        a.recycle();
    }
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        int lastStartPos = ((childCount - 1) / 3) * 3;
