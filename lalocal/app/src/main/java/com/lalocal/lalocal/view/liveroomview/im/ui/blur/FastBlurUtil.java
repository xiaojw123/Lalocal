package com.lalocal.lalocal.view.liveroomview.im.ui.blur;
...
public class FastBlurUtil {
    ...
    public static Bitmap blur(Bitmap originBitmap, int scaleRatio, int blurRadius) {
        ...
        Bitmap scaledBitmap = doScale(originBitmap, scaleRatio);
    ...
    private static Bitmap doScale(Bitmap originBitmap, int scaleRatio) {
    ...
    private static Bitmap doBlur(Bitmap bitmap, int blurRadius) {
        if(bitmap == null) {
            return null;
        }

        // make this bitmap mutable
        return doBlur(bitmap.copy(bitmap.getConfig(), true), blurRadius, true);
    }
    ...
    public static <T> String generateBlurImageKey(T uri, int blurRadius, int scaleRatio) {
        return new StringBuilder().append("blur").append("_")
                .append(uri).append("_").append(blurRadius)
                .append("_").append(scaleRatio)
                .toString();
    }
}
